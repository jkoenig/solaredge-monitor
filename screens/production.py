...
def render_production_screen(data: EnergyDetails) -> Image:
    """
    Render the Produktion screen showing PV production breakdown.
    ...
    # Baseline align by matching the bottom of the unit text to the bottom of the value text
    ...
    # Calculate battery energy: production - self_consumption - feed_in
