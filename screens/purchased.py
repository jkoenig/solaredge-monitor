...
def render_purchased_screen(data: EnergyDetails) -> Image:
    ...
    gap_value_bar = 20
    gap_bar_label = 5
    bar_label_text = "100% vom Tagesverbrauch"
    ...
    draw_horizontal_bar(draw, bar_bbox, percentage, bar_font, legend=f"{int(percentage)}% vom Tagesverbrauch")
